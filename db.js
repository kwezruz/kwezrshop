...
// DATA_DIR — bazaning qayerda saqlanishi. Render'da bu doimiy diskka
// (masalan /var/data) ishora qilishi SHART, aks holda har bir yangi deploy
// bazani butunlay o'chirib, bo'sh holatga qaytaradi (Render'ning odatiy
// fayl tizimi vaqtinchalik — deploy'lar orasida saqlanmaydi).
// Render Dashboard > Settings > Disks bo'limida disk qo'shib, uning
// "Mount Path"ini shu yerdagi DATA_DIR muhit o'zgaruvchisiga bering
// (masalan DATA_DIR=/var/data). Agar DATA_DIR berilmasa, mahalliy
// kompyuterda ishlash uchun loyihaning o'zidagi "data" papkasi ishlatiladi.
